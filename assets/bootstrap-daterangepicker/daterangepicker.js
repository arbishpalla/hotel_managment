...
!function ($) {
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    '<div>' +
                      ...
                      '<input class="input-mini" type="text" disabled name="start"  id="from" />' +
                    '</div>' +
                    '<div>' +
    ...
    DateRangePicker.prototype = {
        ...
        updateView: function () {
            ...
            this.container.find('input[name=start]').val(this.startDate.toString(this.format));
            this.container.find('input[name=end]').val(this.endDate.toString(this.format));
        ...
        enterRange: function (e) {
            ...
            if (label == this.locale.customRangeLabel) {
                ...
                this.container.find('input[name=start]').val(dates[0].toString(this.format));
                this.container.find('input[name=end]').val(dates[1].toString(this.format));
            }
        },
        ...
        enterDate: function (e) {
            ...
            if (cal.hasClass('left')) {
                this.container.find('input[name=start]').val(this.leftCalendar.calendar[row][col].toString(this.format));
            } else {
                this.container.find('input[name=end]').val(this.rightCalendar.calendar[row][col].toString(this.format));
            }
